...
def create_patient(post_request, user):
    ...
    patient = Patient.objects.create(fullname=fullname, birthday=birthday, address=address, phone=phone,
                                     doc_type=doc_type, doc_series=doc_series, doc_number=doc_number,
